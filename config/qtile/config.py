...
def move(qtile, direction, floating_move_amount=50):
    ...
    Example usage:
        ...
        keys.extend([
            Key([mod, "shift"], 'k', move("up")
            Key([mod, "shift"], 'j', move("down"),
            Key([mod, "shift"], 'h', move("left"),
            Key([mod, "shift"], 'l', move("right"),
        ])
    """
    window = qtile.current_window
    current_layout = qtile.current_layout.info()["name"]
    if (window.floating) or (current_layout == "floating"):
...
def resize(qtile, direction, floating_grow_amount=50):
    ...
    Example usage:
        ...
        keys.extend([
            Key([mod, "control"], 'k', resize("up")),
            Key([mod, "control"], 'j', resize("down")),
            Key([mod, "control"], 'h', resize("left")),
            Key([mod, "control"], 'l', resize("right")),
        ])
    """
...
keys = [
    ...
    Key([mod, "shift"], "n", lazy.group.prev_window()),
    Key([mod, "control"], "n", lazy.layout.reset()),

    # RESIZE UP, DOWN, LEFT, RIGHT
    Key([mod, "control"], "l", resize("right")),
    Key([mod, "control"], "Right", resize("right")),
    Key([mod, "control"], "h", resize("left")),
    Key([mod, "control"], "Left", resize("left")),
    Key([mod, "control"], "k", resize("up")),
    Key([mod, "control"], "Up", resize("up")),
    Key([mod, "control"], "j", resize("down")),
    Key([mod, "control"], "Down", resize("down")),
    ...
    Key([mod, "shift"], "Up", move("up")),
    Key([mod, "shift"], "Down", move("down")),
    Key([mod, "shift"], "Left", move("left")),
    Key([mod, "shift"], "Right", move("right")),
...
def init_widgets_list(screen_id=1) -> list:
    ...
    widgets_list = [
        ...
        vert_sep,
        group_id,
        widget.Spacer(background=colors['background'], length=bar.STRETCH),
        window_wdg,
        widget.Spacer(background=colors['background'], length=bar.STRETCH),
        vert_sep,
        monitor_btn,
